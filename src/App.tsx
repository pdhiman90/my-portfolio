...
//     description: "I'm a full stack developer passionate about building AI-powered applications that solve real-world problems. My goal is to create innovative solutions that bridge the gap between cutting-edge technology and everyday users.",
//     image: "/profile.jpg",
//   };
...
//       { class: "fab fa-github", color: "text-gray-800" },
//       { class: "fab fa-docker", color: "text-blue-600" },
//     ],
//     skills: [
...
//           <div
//             className={`p-8 ${isDarkMode ? "bg-gray-900 text-white" : "bg-white text-black"}`}
//           >
//             <AboutSection myinfo={aboutMe} />
//           </div>
//         </div>
...
//   return (
//     <>
//       {/* <div className="container left-0 right-0 top-0 ml-9"> */}
//       <div className={`w-full min-h-screen ${isDarkMode ? "bg-gray-900 text-white" : "bg-white text-black"}`}>
...
//             setActiveSection(section);  // Update state with the active section
//             scrollToSection(section);   // Scroll to the relevant section
//           }}
//           isDarkMode={isDarkMode}
//           sections={sections}
//           scrollToSection={scrollToSection}
...
//         <div ref={skillsRef}>
//           <h1 className="text-4xl md:text-5xl font-montserrat mb-4">Skills</h1>
//           <div className="container mx-auto p-8">
//             <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
//               <SkillsCard {...frontendData} isDarkMode={isDarkMode} />
//               <SkillsCard {...backendData} isDarkMode={isDarkMode} />
...
//         <div ref={projectsRef} className={` min-h-screen transition-all duration-500`}>
//           <h1 className="text-4xl md:text-5xl font-montserrat mb-4">Projects</h1>
//           <div className="container mx-auto p-8">
//             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//               {/* <ProjectCard
//                 image="/project1.jpg"
...
//         <div ref={contactRef} className="p-8 space-y-8">
//         <h1 className="text-4xl md:text-5xl font-montserrat mb-4">Contact Me</h1>
//           <div
//           >
//             <ContactForm
//               onSubmit={handleSubmit}
